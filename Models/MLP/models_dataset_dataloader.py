...
class CustomVideoDataset(Dataset):
    def __init__(self, hdf5_path, video_types=('circular'), resolution=(480, 640), crop_size=(20, 20), label_size=(2, 2)):
    ...
    def __getitem__(self, index):
        ...
        label_data = self.masks[vtype][(crop_top_left[0]+self.crop_size[0]//2-self.label_size[0]//2):(crop_top_left[0] + self.crop_size[0]//2+self.label_size[0]//2),
                                       (crop_top_left[1]+self.crop_size[1]//2-self.label_size[1]//2):(crop_top_left[1] + self.crop_size[1]//2+self.label_size[1]//2)]
        assert label_data.shape == self.label_size, f"label_data shape {label_data.shape} is invalid"
...
def create_dataloader(
    ...
    resolution=(480, 640), crop_size=(20, 20), label_size=(2, 2),
    batch_size=32, shuffle=True, num_workers=0, crop_fraction=0.001):
    ...
    num_samples = max(1, int(total_len * crop_fraction))
