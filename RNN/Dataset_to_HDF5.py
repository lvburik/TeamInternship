...
npy_dir = 'C:/Users/20202555/OneDrive - TU Eindhoven/Documents/M AI&ES - Year 1/Team-internship/Experimental_Data/Resin'
...
hdf5_path = 'compacted_improved.h5'  # Set your output HDF5 file path

# %%
with h5py.File(hdf5_path, 'w') as h5f:
    num_frames = 1300
    sample_size = max(1, int(num_frames * 0.02))  # Sample 2% of frames
    sampled_indices = np.linspace(0, num_frames - 1, sample_size, dtype=int)
